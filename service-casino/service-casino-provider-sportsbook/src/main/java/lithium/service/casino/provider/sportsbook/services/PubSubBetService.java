...
public class PubSubBetService {
    ...
    public void buildAndSendPubSubBetReserveMessage(BetReserveRequest betReserveRequest, long userId){
        ...
        try {
            ...
            log.debug("Message "+ message +" sent to pup sub channel" );
    ...
    public void buildMultipleSettlementsMessages(SettleMultiContext context) {
        for (lithium.service.casino.provider.sportsbook.context.objects.SettlementEntry entry : context.getSettlement().getSettlementEntries()){
            PubSubBetPlacementMessage message = PubSubBetPlacementMessage.builder()
                    .accountGuid(context.getUser().getGuid())
    ...
    private CasinoTranType resolveCasinoSportsType(final lithium.service.casino.provider.sportsbook.context.objects.SettlementEntry entry) {

        return resolveCasinoSportsType(SettlementEntry.builder()

...
import static lithium.service.client.objects.placeholders.PlaceholderBuilder.USER_BIOMETRIC_STATUS;
...
public class DwhNotificationPlaceholdersBuilder {
    ...
    public DwhNotificationPlaceholdersBuilder setBiometricStatus(String biometricStatus) {
    ...
    public Set<Placeholder> build() {
        ...
        placeholders.add(USER_BIOMETRIC_STATUS.from(biometricStatus));

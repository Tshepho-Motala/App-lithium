...
import lithium.service.reward.provider.casino.pragmatic.enums.RewardTypeName;
...
public class ServiceRewardProviderCasinoPragmaticApplication extends LithiumServiceApplication {
  ...
  public static void main(String[] args) {
    LithiumShutdownSpringApplication.run(ServiceRewardProviderCasinoPragmaticApplication.class, args);
  }

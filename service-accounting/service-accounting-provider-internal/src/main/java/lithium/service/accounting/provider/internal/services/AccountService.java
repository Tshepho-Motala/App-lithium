...
public class AccountService {
	...
	public Account lockingUpdate(Long accountId) {
		...
		try {
			...
			long waitTime = lockAcquired.getTime() - lockRequested.getTime();
			metrics.recordTime(
					"accounting_service_lock_latency",
					"Time taken to acquire a lock on accounting",

		...
		function($translate, $state, $rootScope, $http, jwtHelper, $q, $security, $menu, $filter, $timeout, $uibModal, restDomain, notify, errors) {
			try {
				...
				service._buildMenu = function() {
					...
					$menu.add("TREE", "USER_THRESHOLD_HISTORY_VIEW", "depositthreshold", "dashboard.depositthreshold", "Deposit Threshold Trigger", "th-list", reporting);
					$menu.add("TREE", "USER_THRESHOLD_HISTORY_VIEW", "threshold", "dashboard.threshold", "Limits Threshold History", "th-list", reporting);
					...
					$menu.add("TREE", "casino_bet_history_*", "bet-history", "dashboard.casino.bet-history", "Bet History", "list-alt", casino);

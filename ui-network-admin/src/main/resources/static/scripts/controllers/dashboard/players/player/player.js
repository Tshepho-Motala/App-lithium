...
angular.module('lithium')
	...
	function(user, userData, tabs, domainInfo, playerBalance, limits, depositLimits, balanceLimits, coolOff, realityCheck, selfExclusion, userRestrictions, ltDeposits, ltWithdrawals, pendingWithdrawals, unlockedGameUserStatuses, UserRest, $scope, $state, $uibModal, restDomain, $security, $filter, restPaymentMethods, domainSettings, playerTableBoolean) {
		var controller = this;
		...
		controller.playerTableBoolean = playerTableBoolean

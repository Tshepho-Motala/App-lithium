        ...
        controller: ['$dt', '$translate', 'rest-user-mass-action', '$scope', 'DTOptionsBuilder', 'notify', '$filter', '$compile', '$state', 'userFields', 'accountingFields', 'ChangelogsRest', 'RestrictionsRest',
            function($dt, $translate, userMassActionRest, $scope, DTOptionsBuilder, notify, $filter, $compile, $state, userFields, accountingFields, changelogsRest, restrictionsRest) {
                ...
                controller.fields = {
                    ...
                    autoRestrictionRules: [
                        {
                            className: "col-xs-10",
                            key: "autoRestrictionRules",
                            type: "checkbox",
                            templateOptions: {
                                label: "",
                                description: "",
                            ...
                            expressionProperties: {
                                'templateOptions.label': '"UI_NETWORK_ADMIN.PLAYERS.MASS_UPDATE.ACTIONS.AUTO_RESTRICTION_RULES.LABEL" | translate',
                                'templateOptions.disabled': function(viewValue) {
                                    controller.autoRestrictionRules = viewValue;
                                }
                            }
                        }
                    ],
                        ...
                        for (let action of massActionMeta.actions) {
                            switch (action.name) {
                                ...
                                case 'AUTO_RESTRICTION_RULES' : {
                                    controller.model.autoRestrictionRules = controller.autoRestrictionRules;
                                    break;
                                }
                            }
                        }
                    ...
                    for (let actionsType = 0; actionsType < controller.actionsRequest.actions.length; actionsType++) {
                        switch (controller.actionsRequest.actions[actionsType]) {
                            ...
                            case "CHANGE_VERIFICATION_STATUS": {
                                ...
                                if(controller.model.verificationStatus === 2 &&
                                    (controller.model.addressVerified === null || controller.model.addressVerified === undefined) &&
                                    (controller.model.ageVerified === null || controller.model.ageVerified === undefined)) {
                                    valid = false
                                }

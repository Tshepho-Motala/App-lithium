                        ...
                        dtBuilder.column($dt.columnformatdatetime('date').withTitle($translate('UI_NETWORK_ADMIN.ACCOUNTING.TRANSACTIONS.FIELDS.DATE.LABEL')).notSortable())
                            ...
                            .column($dt.linkscolumn($translate('UI_NETWORK_ADMIN.ACCOUNTING.TRANSACTIONS.FIELDS.PROVIDERTRANID.LABEL'),
                                [{
                                    ...
                                    href: function (data) {
                                        let res = data.details.externalTransactionDetailUrl
                                        if(data?.details?.externalTransactionDetailUrl && data.details.externalTransactionDetailUrl.includes('CashierTransactionID')){
                                            res =  `#/dashboard/cashier/${data.account.domain.name}/view/${data.details.externalTranId}`
                                        } else if(data?.details?.externalTransactionDetailUrl) {
                                            res = data.details.externalTransactionDetailUrl
                                        }
                                        return res;
                                    },
                                    target: "_blank",

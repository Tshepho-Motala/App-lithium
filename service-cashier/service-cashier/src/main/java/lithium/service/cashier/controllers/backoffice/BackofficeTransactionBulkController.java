...
public class BackofficeTransactionBulkController {
    ...
    public Response<BulkResult> proceedByIds(
        ...
        try {
            BulkResult approveResponses = transactionBulkProcessingService.proceed(transactionProcessingCode, transactionIds, "Bulk " + transactionProcessingCode.getCode() , token);

...
public class DepositService {
    ...
    public DoProcessorResponseStatus initiateUssdDeposit(DoProcessorRequest request, DoProcessorResponse response, RestTemplate rest) throws Exception {
	    ...
	    log.debug("Got ussd charges response: " + exchange.getBody() + " .TransactionId=" + request.getTransactionId());
    ...
    public DoProcessorResponseStatus recurringWebDeposit(DoProcessorRequest request, DoProcessorResponse response, RestTemplate rest) throws Exception {
	    ...
	    log.debug("Paystack init recurring web deposit request" + authorizationRequest + " .TransactionId=" + request.getTransactionId());
	    ...
	    log.debug("Paystack init transaction id=" + request.getTransactionId() + " recurring web deposit response " + exchange.getBody());
    ...
    public DoProcessorResponseStatus initiateWebDeposit(DoProcessorRequest request, DoProcessorResponse response, RestTemplate rest) throws Exception {
	    ...
	    log.debug("Paystack init web deposit request" + initializeTransactionRequest + " .TransactionId=" + request.getTransactionId());
	    ...
	    log.debug("Paystack init transaction id=" + request.getTransactionId() + " web deposit response " + exchange.getBody());

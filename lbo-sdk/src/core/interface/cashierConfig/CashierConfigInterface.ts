...
export interface CashierConfigProcessor {
    ...
    accountingDay?: DomainAccountingInfoInterface | null,
    accountingLastMonth?: DomainAccountingInfoInterface | null,
    accountingMonth?: DomainAccountingInfoInterface | null,
    accountingWeek?: DomainAccountingInfoInterface | null,
    accountingUserDay?: DomainAccountingInfoInterface | null,
    accountingUserLastMonth?: DomainAccountingInfoInterface | null,
    accountingUserMonth?: DomainAccountingInfoInterface | null,
    accountingUserWeek?: DomainAccountingInfoInterface | null,
    active?: boolean | null,
    changelog?: {
        domainName: string,
...
export interface CashierProfileUser {
    guid?: string,
    id?: number | null,
    limits?: CashierConfigLimits | null,
...
export interface CashierTableHeader {
    id: number,
    text: string,
    value: string
}

export interface CashierTableData {
    draw: number,
    start: number,
    length: number,
    [key: string]: any
...
export interface CashierProfileTab {
    id: number,
    name: string,
    roles: string
}

export interface DomainAccountingInfoInterface {
    tranCount?: string

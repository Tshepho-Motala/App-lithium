  ...
  <div>
    ...
    >
      <v-card>
        ...
        <v-card-text class="mt-4 mb-0 pb-0">
          <div class="last-transactions__wrapper">
            ...
            <v-alert
                ...
                type="success"
            >
              All transactions are successfully
            </v-alert>
          ...
          <div class="d-flex">
            <v-spacer></v-spacer>
            <v-checkbox
                v-model="clearCashier"
                label="Clear global cashier transaction filters"
            ></v-checkbox>
          </div>
        ...
        <v-card-actions>
          <div  class="mt-2" style="width: 350px;">
            <v-select
                outlined
                dense
                v-model="statuses"
...
export default class WithdrawalBulk extends Mixins(cashierMixins) {
  ...
  headers = [
    ...
    {text: 'Processor', sortable: true, value: 'processorDescription'},
  ...
  async clearParams(){
    if(this.hasProps && this.params !== null){
      ...
      await  this.rootScope.provide.bulkTransactionProvider.clearParams()
    }
    this.dialog = false
  }

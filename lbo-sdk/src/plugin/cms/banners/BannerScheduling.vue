<template>
  <v-row id="banner-scgeduling" class="pt-2">
    <v-col cols="12">
      <RRuleComponent :schedule="schedule" :recurrencePattern="banner.recurrencePattern" @change="onRruleChange" :eventTitle="eventTitle" :timezone="timezone" />
    </v-col>
  </v-row>
</template>

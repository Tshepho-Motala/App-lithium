...
public interface KycTypeProviderProperty {
    ...
    ProviderConfigProperty NIN_V2 = ProviderConfigProperty.builder()
            .name(VerificationMethodType.METHOD_NIN_V2.getValue())
            .required(true)
            .tooltip("Enable to allow NIN_2 verification check")
            .dataType(Boolean.class)
            .version(1)
            .build();

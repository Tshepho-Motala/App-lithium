...
public class FrontendApiController {
    ...
    public StatusResponse submitCheck(@PathVariable String domainName,
                                      ...
                                      LithiumTokenUtil tokenUtil) throws Status400DisabledOnfidoReportException,
            Status411FailOnfidoServiceException, Status512ProviderNotConfiguredException,
            Status500InternalServerErrorException, Status412NotFoundApplicantException, Status416IncompleteCheckException {
    ...
    public StatusResponse statusCheck(@PathVariable String domainName,
                                      @RequestParam(name = "reportType", required = false, defaultValue = "document_with_address_information") String reportType,
        ...
        OnfidoCheck onfidoCheck = onfidoService.getLastCheck(tokenUtil.guid(), reportType)
                .orElseThrow(() -> {
        ...
        return StatusResponse.mapStatus(onfidoCheck.getStatus());
    }
}

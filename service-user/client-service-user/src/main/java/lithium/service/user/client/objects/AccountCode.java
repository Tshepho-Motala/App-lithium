...
public enum AccountCode {
    ...
    GF_BALANCE_RECOVERY_DEBIT("GF_BALANCE_RECOVERY_DEBIT", true, false),
    ...
    GF_SE_BALANCE_WITHHOLD_DEBIT("GF_SE_BALANCE_WITHHOLD_DEBIT", true, false),
    GF_SE_BALANCE_WITHHOLD_CREDIT("GF_SE_BALANCE_WITHHOLD_CREDIT", false, true),
    GF_BALANCE_RECOVERY_CREDIT("GF_BALANCE_RECOVERY_CREDIT", false, true);

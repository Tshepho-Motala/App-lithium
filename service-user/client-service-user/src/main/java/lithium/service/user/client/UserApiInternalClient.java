...
//	public Response<User> updateUser(User user);
	...
	public Response<User> updateBiometricsStatus(@RequestBody @Valid UserBiometricsStatusUpdate userBiometricsStatusUpdate) throws Status462IncompleteOnfidoCheckException, Status463CantUpdateBiometricStatusException;

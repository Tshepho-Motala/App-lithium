...
public class UserProviderService {
    ...
    if (localUser.isSuccessful() && localUser.getData() != null) {
      if (localUser.getData().getPasswordHash() != null) {
        if (!localUser.getData().getPasswordHash().isEmpty()) {
          ...
          if (localUser.getData().getPasswordHash().startsWith("st:")) {
  ...
  private void addUserGroups(User userEntity) {
    if (userEntity.hasGroups()) {
      ...
      if (!sourceGroups.equals(userEntity.getGroups())) {

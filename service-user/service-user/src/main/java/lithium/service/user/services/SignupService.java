...
public class SignupService {
  ...
  private lithium.service.domain.client.objects.Domain getExternalDomain(String domainName)
...
//		if ((signupAccessRule == null) || (signupAccessRule.isEmpty())) return;
  ...
  public User preRegisterPlayer(
    ...
    User user = userService.buildUser(pb, domain, residentialAddress, postalAddress, status, statusReason, passwordHash);
  ...
  private Address validateAndOverrideGeoData(AddressBasic addressBasic, String addressType, String domainName)

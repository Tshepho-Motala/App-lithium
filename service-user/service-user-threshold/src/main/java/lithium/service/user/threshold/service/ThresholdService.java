...
public interface ThresholdService {
  ...
  default ThresholdDto empty() {
    ThresholdDto dto = ThresholdDto.builder().build();
    ThresholdRevisionDto revDto = ThresholdRevisionDto.builder().threshold(dto).percentage(BigDecimal.ZERO).amount(BigDecimal.ZERO).build();
    dto.setCurrent(revDto);
    return dto;
  }
}

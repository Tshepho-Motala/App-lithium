...
public class LimitInternalSystemService {
     ...
     */
    public PlayerLimitV2Dto findPlayerLimitV2WithNetLoss(String domainName, String playerGuid, Integer playerAge, Integer granularity, Integer type) {
        return getClient().findPlayerLimitV2WithNetLoss(domainName, playerGuid, playerAge, granularity, type);
    }

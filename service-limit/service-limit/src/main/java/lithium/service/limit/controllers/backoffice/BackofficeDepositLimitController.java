...
public class BackofficeDepositLimitController {
	...
	public void removePending(
		...
		log.debug("Admin request to remove pending deposit limits for "+playerGuid+".");
		DomainValidationUtil.validate(domainName, playerGuid.split("/")[0]);
	...
	public void removeSupposed(
		...
		log.debug("Admin request to remove supposed deposit limits for "+playerGuid+".");
		DomainValidationUtil.validate(domainName, playerGuid.split("/")[0]);
	...
	public void remove(
		...
		log.debug("Admin request to remove deposit limits for "+playerGuid+".");
		DomainValidationUtil.validate(domainName, playerGuid.split("/")[0]);
